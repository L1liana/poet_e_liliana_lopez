        ...
        <div class="ejeZfooter">
            <div class="footer-content">
                ...
                <div class="formulario-content">
                    <form action="<?php echo e(action('Controlador@validarLogin')); ?>" method="post" id="formulario">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\poets\resources\views/admon/login.blade.php ENDPATH**/ ?>